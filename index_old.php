	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header" style="background:#008080">
	  ...
	  <main class="mdl-layout__content" style="background-color: #E9E9E9; padding: 10px;height: 100vh">
		...
		<div class="jumbotron mdl-shadow--2dp" style="border: 0px solid black; float:right; width:50%; background: #008E7E;padding:15px;margin-bottom:0px;" id = "jt2">
			<div class="demo-card-wide mdl-card mdl-shadow--2dp" style="padding:5px;min-height:100px;">
			<table border = "0px solid black" id = table1>
				<?php
				if(isset($_POST['submit']) && !empty($_POST) )
				{
					...
					{
						echo '<td id = vc>'.$nop.'</td></tr>';
					}
					echo "<tr><td colspan = 2 id = result>Station will be ";
					if($nop <= 250)
					{
						echo "mostly empty at this time</td></tr>";
					}
					else if($nop >250 && $nop <= 750)
					{
						echo "crowed at this time</td></tr>";
					}
					else
					{
						echo "heavily crowed at this time</td></tr>";
					}
				}
				?>
				</table>
			</div>
			<div id="chartContainer" class = "mdl-shadow--2dp" style="height: 400px; max-width: 920px; margin: 0px auto;margin-top:20px;">
			<?php 
